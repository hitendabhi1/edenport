...
function twentytwenty_get_elements_array() {
	...
	wp_enqueue_style( 'site_main_css', get_template_directory_uri() . '/build/main.min.css' );
	wp_enqueue_script( 'site_main_js', get_template_directory_uri() . '/build/main.min.js' , null , null , true );
